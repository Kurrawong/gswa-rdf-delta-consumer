...
from azure.servicebus import TransportType, ServiceBusReceiveMode
...
MAX_WAIT_TIME = 5
TIMEOUT = 10.0
MAX_LOCK_RENEWAL_DURATION_SEC = 100.0
            ...
            try:
                ...
                async with receiver:
                    ...
                    for message in messages:
                        ...
                        logger.info(
                            f"Message processed successfully. Message ID {message.message_id}"
                        )
